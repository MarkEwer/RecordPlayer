namespace ME.RecordPlayer.EventSourcing.Tests
{
    ...
    public class Snapshot_Strategy_Scenarios
    {
        ...
        [Fact]
        public void Validate_EventTypeStrategy_Should_Snapshot_According_To_The_Event_Type()
        {
        ...
        public void Validate_IntervalStrategy_Should_Snapshot_According_To_The_Interval(int interval, int[] expected)
        {
            ISnapshotStrategy strategy = null;
        ...
        [Fact]
        public void Validate_TimeStrategy_Should_Snapshot_According_To_The_Timespan()
        {
            ISnapshotStrategy strategy = null;

...
namespace ME.RecordPlayer.EventSourcing
{
  public class Recorder
  {
    ...
    /// <summary>
    ///   Recovers the actor to the latest state by recoving the newest snapshot then replaying all
    ///   events after that snapshot.
    /// </summary>
    /// <returns></returns>
...
#pragma warning restore CS8602
    ...
    /// <summary>
    ///   Allows the replaying of events to rebuild state from a range. For example, if we want to
    ///   replay until just before something happened (i.e. unexpected behavior of the system, bug,
    ///   crash etc..) then apply some messages and observe what happens.
    /// </summary>
